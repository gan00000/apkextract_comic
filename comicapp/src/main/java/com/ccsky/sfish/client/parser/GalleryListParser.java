...
import com.ccsky.sfish.client.data.GalleryTagGroup;
import com.ccsky.util.ExceptionUtils;
import com.ccsky.util.JsoupUtils;
    ...
    private static GalleryInfo parseGalleryInfo(Element e) {
        ...
        if (glthumb != null) {
            ...
            if (img != null) {
                ...
                gi.thumb = SkyUtils.handleThumbUrlResolution(url);
            }
        ...
        if (gi.thumb == null) {
            ...
            if (gl != null) {
                ...
                if (img != null) {
                    ...
                    gi.thumb = SkyUtils.handleThumbUrlResolution(img.attr("src"));
                }
            }
        }
        ...
        if (gi.favoriteSlot == -2) {
            gi.favoriteSlot = SkyDB.containLocalFavorites(gi.gid) ? -1 : -2;
        }
