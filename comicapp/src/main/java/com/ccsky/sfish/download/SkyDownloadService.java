...
package com.ccsky.sfish.download;
...
public class SkyDownloadService extends Service implements DownloadManager.DownloadListener {
    ...
    public void onCreate() {
        ...
        mDownloadManager = SkyApplication.getDownloadManager(getApplicationContext());
    ...
    private void ensureDownloadingBuilder() {
        ...
        Intent stopAllIntent = new Intent(this, SkyDownloadService.class);
    ...
    private void ensureDownloadedBuilder() {
        ...
        Intent clearIntent = new Intent(this, SkyDownloadService.class);
        ...
        Intent activityIntent = new Intent(this, SkyMainActivity.class);
        ...
        PendingIntent piActivity = PendingIntent.getActivity(SkyDownloadService.this, 0,
                activityIntent, PendingIntent.FLAG_UPDATE_CURRENT);

        mDownloadedBuilder = new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                .setSmallIcon(android.R.drawable.stat_sys_download_done)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.iconaa))
    ...
    public void onStart(DownloadInfo info) {
        ...
        mDownloadingBuilder.setContentTitle(SkyUtils.getSuitableTitle(info))
                .setContentText(null)
                .setContentInfo(null)
    ...
    public void onFinish(DownloadInfo info) {
        ...
        if (index < 0) { // Not contain
            ...
            sItemTitleArray.put(gid, SkyUtils.getSuitableTitle(info));
            sDownloadedCount++;
            if (finish) {
                sFinishedCount++;
            } else {
